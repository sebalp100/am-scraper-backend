...
# 📖 Amazon Scraper Backend<a name="about-project"></a>

Backend server made with Bun and Express that allows the user to scrape Amazon products.
...
`powershell -c "irm bun.sh/install.ps1 | iex"` in case you don't have bun installed 
